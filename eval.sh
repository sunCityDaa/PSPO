...
TASKS="aime25 aime24 math_500 amc23 minerva olympiadbench"
...
get_revision() {
    ...
    if [ "$exp" = "1" ]; then
        case $step in
            # 50)  echo "/data/model/Qwen2.5-Math-1.5B" ;;
            # 100) echo "/data/model/Qwen2.5-Math-1.5B-Instruct" ;;
            150) echo "/data/model/Qwen2.5-Math-1.5B-Instruct" ;;
    ...
    # DRGRPO
        ...
        case $step in
            50)  echo "/data/ER-GRPO/Qwen2.5-Math-7B-Instruct-data-DrGRPO/Merged/ER-GRPO-alpha99-newSTD" ;;
            100) echo "/data/ER-GRPO/Qwen2.5-Math-7B-Instruct-data-DrGRPO/Merged/ERPER-GRPO-alpha99-newSTD" ;;
            150) echo "/data/ER-GRPO/Qwen2.5-Math-7B-Instruct-data-DrGRPO/Merged/PER-GRPO" ;;
            200)  echo "/data/ER-GRPO/Qwen2.5-Math-7B-data-DrGRPO/Merged/ER-GRPO-alpha99-newSTD" ;;
            250) echo "/data/ER-GRPO/Qwen2.5-Math-7B-data-DrGRPO/Merged/ERPER-GRPO-alpha99-newSTD" ;;
            300) echo "/data/ER-GRPO/Qwen2.5-Math-7B-data-DrGRPO/Merged/PER-GRPO" ;;
    ...
    # GRPO
        ...
        case $step in
            50)  echo "/data/ER-GRPO/Qwen2.5-Math-1.5B-Instruct-data-drGRPO/ER-GRPO-alpha99-newSTD/checkpoint-50" ;;
            100) echo "/data/ER-GRPO/Qwen2.5-Math-1.5B-Instruct-data-drGRPO/ERPER-GRPO-alpha99-newSTD/checkpoint-50" ;;
            150) echo "/data/ER-GRPO/Qwen2.5-Math-1.5B-Instruct-data-drGRPO/PER-GRPO/checkpoint-50" ;;
            200) echo "/data/ER-GRPO/Qwen-Math-1.5B-data-drGRPO/ERPER-GRPO-alpha99-newSTD/checkpoint-50" ;;
            250) echo "/data/ER-GRPO/Qwen-Math-1.5B-data-drGRPO/ER-GRPO-alpha99-newSTD/checkpoint-50" ;;
            300) echo "/data/ER-GRPO/Qwen-Math-1.5B-data-drGRPO/PER-GRPO/checkpoint-50" ;;
    ...
    # ERGRPO-STD
        ...
        case $step in
            50)  echo "/data/ER-GRPO/data_drpo-false/PER-GRPO/checkpoint-50" ;;
            100) echo "/data/ER-GRPO/data_drpo-false/ER-GRPO-alpha99-newSTD/checkpoint-50" ;;
            150) echo "/data/ER-GRPO/data_drpo-false/ERPER-GRPO-alpha99-newSTD/checkpoint-50" ;;
            # 200) echo "/data/ER-GRPO/Qwen2.5-Math-7B-Instruct-data-DrGRPO/Merged/ER-GRPO-alpha99-newSTD" ;;
            # 250) echo "/data/ER-GRPO/Qwen2.5-Math-7B-Instruct-data-DrGRPO/Merged/ERPER-GRPO-alpha99-newSTD" ;;
            # 300) echo "/data/ER-GRPO/Qwen2.5-Math-7B-Instruct-data-DrGRPO/Merged/PER-GRPO" ;;
        ...
        case $step in
            50)  echo "/data/ER-GRPO/Qwen-Math-1.5B-data-drGRPO/ER-GRPO-alpha99-newSTD/checkpoint-50" ;;
            100) echo "/data/ER-GRPO/Qwen-Math-1.5B-data-drGRPO/ERPER-GRPO-alpha99-newSTD/checkpoint-50" ;;
            150) echo "/data/ER-GRPO/Qwen-Math-1.5B-data-drGRPO/PER-GRPO/checkpoint-50" ;;
            200) echo "/data/ER-GRPO/Qwen2.5-Math-1.5B-Instruct-data-drGRPO/ER-GRPO-alpha99-newSTD/checkpoint-50" ;;
            250) echo "/data/ER-GRPO/Qwen2.5-Math-1.5B-Instruct-data-drGRPO/ERPER-GRPO-alpha99-newSTD/checkpoint-50" ;;
            300) echo "/data/ER-GRPO/Qwen2.5-Math-1.5B-Instruct-data-drGRPO/PER-GRPO/checkpoint-50" ;;
    ...
    # alpha 消融实验，Num_genrations
        ...
        case $step in
            # 50)  echo "/data/ER-GRPO/Qwen2.5-Math-7B-Instruct-data/Merged/ERPER-GRPO-alpha99-newSTD" ;;
            # 100) echo "/data/ER-GRPO/Qwen2.5-Math-7B-data/Merged/ERPER-GRPO-alpha99-newSTD" ;;

            150) echo "/data/ER-GRPO/Qwen2.5-Math-7B-Instruct-data/Merged/ER-GRPO-alpha99-newSTD" ;;
            200) echo "/data/ER-GRPO/Qwen2.5-Math-7B-data/Merged/ER-GRPO-alpha99-newSTD" ;;
...
get_steps() {
    ...
    case $exp in
        1) echo "150" ;;
        2) echo "50 100 150 200 250 300" ;;
        3) echo "50 100 150 200 250 300" ;;
        # 4) echo "50 100 150 200 250 300 350 400 450 500" ;;
        4) echo "50 100 150" ;;
        # 5) echo "50 100 150 200 250 300 350" ;;
        5) echo "50 100 150 200 250 300" ;;
        6) echo "150 200" ;;
...
run_evaluation() {
    ...
    output_dir="logs/evals-1.5B/Exp${experiment}_${step}"
